...
def run_metric_unit_trial(payload: dict[str, Any], receipt: dict[str, Any]) -> dict[str, Any]:
    ...
    probes = []
    for metric, unit in (("first_response_hours", "minutes"), ("monthly_support_volume", "contacts/day"),
                         ("repetitive_contact_share_pct", "ratio"), ("first_response_hours", None)):
        ...
        probes.append({"metric": metric, "input_route": "mapping", "rejected": rejected,
    ...
    try:
        ...
        rejected = "requires unit" in str(exc)
    probes.append({"metric": "first_response_hours", "input_route": "typed_container", "rejected": rejected,
