...
M6 should add one bounded review/reporting improvement around the receipt or conflict triage. Do not promote evidence, rewrite a memo or add a model/provider path without a separate evidence-backed contract.
