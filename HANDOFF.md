...
M7 should add one bounded review/reporting improvement around triage outcome visibility. Do not promote evidence, rewrite a memo or add a model/provider path without a separate evidence-backed contract.
